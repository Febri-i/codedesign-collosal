...
export default function License() {
  return (
    <>
      <CollosalTitle title="License" />

      <div class="text-center">
        <CenteredHeading title="PAGE" heading="Terms & Conditions" />
        <p class="!text-sm mb-14 mt-6 ">Updated at 2021-05-06</p>
        <hr />
      </div>
      <div class="!px-44">
        <p>
        ...
        <p>
          ...
          transferable, limited license to download, install and use the website
